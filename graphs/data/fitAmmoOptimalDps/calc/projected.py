...
"""
Projected effects calculations for optimal ammo selection.

This module provides:
- Distance-keyed cache for target speed/sig radius with projected effects
- Re-exports of core projected functions from fitDamageStats

The key optimization is buildProjectedCache() which pre-computes target
speed and signature at all distance intervals ONCE, avoiding repeated
expensive calculations during ammo optimization.
"""
